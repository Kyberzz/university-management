...
public class AppConfigTest {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        jpaProperties.setProperty("javax.persistence.schema-generation.scripts.action", "create");
        jpaProperties.setProperty("javax.persistence.schema-generation.scripts.create-target", "autogeneratedSchema.sql");
